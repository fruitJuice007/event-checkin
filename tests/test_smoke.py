...
from event_checkin.cli import demo_state
from event_checkin.storage import load_state, save_state
from event_checkin.models import generate_short_id
from event_checkin.validation import normalize_tags, require_text, validate_task_status
from event_checkin.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
